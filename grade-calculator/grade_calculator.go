...
func (gc *GradeCalculator) calculateNumericalGrade() int {
	...
	essay_average := computeAverage(gc.essays) // bug fix: previously used gc.exams instead of gc.essays
...
func computeAverage(grades []Grade) int {
	...
	for _, g:= range grades { // bug fix: was summing the index instead of g.Grade
		sum += g.Grade
	}
